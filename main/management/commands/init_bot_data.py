...
BOT_MESSAGES = [
    ...
    {
        'key': 'contacts_title',
        'description': 'Заголовок раздела контактов',
        'texts': {
            'ru': '<b>Контакты FAW Uzbekistan</b>',
            'uz': '<b>FAW Uzbekistan kontaktlari</b>',
            'en': '<b>FAW Uzbekistan Contacts</b>',
        },
    },
    {
        'key': 'contacts_phone',
        'description': 'Телефон в контактах',
        'texts': {
            'ru': 'Телефон: {phone}',
            'uz': 'Telefon: {phone}',
            'en': 'Phone: {phone}',
    ...
    {
        'key': 'contacts_phone_alt',
        'description': 'Дополнительный телефон в контактах',
        'texts': {
            'ru': 'Доп. телефон: {phone}',
            'uz': "Qo'shimcha telefon: {phone}",
            'en': 'Alt. phone: {phone}',
        },
    },
    {
        'key': 'contacts_email',
        'description': 'Email в контактах',
        'texts': {
            'ru': 'Email: {email}',
            'uz': 'Email: {email}',
            'en': 'Email: {email}',
    ...
    {
        'key': 'contacts_hours',
        'description': 'Рабочее время в контактах',
        'texts': {
            'ru': 'Режим работы: {hours}',
            'uz': 'Ish vaqti: {hours}',
    ...
    {
        'key': 'contacts_map',
        'description': 'Кнопка карты в контактах',
        'texts': {
            'ru': 'Открыть на карте',
            'uz': 'Xaritada ochish',
            'en': 'Open on map',
...
BOT_MENU_ITEMS = [
    {'key': 'catalog',    'label_ru': 'Каталог',          'label_uz': 'Katalog',              'label_en': 'Catalog',       'emoji': '', 'order': 1},
    {'key': 'leasing',    'label_ru': 'Лизинг',           'label_uz': 'Lizing',               'label_en': 'Leasing',       'emoji': '', 'order': 2},
    {'key': 'test_drive', 'label_ru': 'Тест-драйв',       'label_uz': 'Test-drayv',           'label_en': 'Test drive',    'emoji': '', 'order': 3},
    {'key': 'lead',       'label_ru': 'Оставить заявку',  'label_uz': 'Ariza qoldirish',      'label_en': 'Leave a request','emoji': '', 'order': 4},
    {'key': 'news',       'label_ru': 'Новости',          'label_uz': 'Yangiliklar',          'label_en': 'News',          'emoji': '', 'order': 5},
    {'key': 'dealers',    'label_ru': 'Дилеры',           'label_uz': 'Dilerlar',             'label_en': 'Dealers',       'emoji': '', 'order': 6},
    {'key': 'faq',        'label_ru': 'Вопросы и ответы', 'label_uz': 'Savol va javoblar',    'label_en': 'FAQ',           'emoji': '', 'order': 7},
    {'key': 'promotions', 'label_ru': 'Акции',            'label_uz': 'Aksiyalar',            'label_en': 'Promotions',    'emoji': '', 'order': 8},
    {'key': 'partner',    'label_ru': 'Сотрудничество',   'label_uz': 'Hamkorlik',            'label_en': 'Partnership',   'emoji': '', 'order': 9},
    {'key': 'contacts',   'label_ru': 'Контакты',         'label_uz': 'Kontaktlar',           'label_en': 'Contacts',      'emoji': '', 'order': 10},
    {'key': 'profile',    'label_ru': 'Мой профиль',      'label_uz': 'Mening profilim',      'label_en': 'My profile',    'emoji': '', 'order': 11},
    {'key': 'language',   'label_ru': 'Сменить язык',     'label_uz': "Tilni o'zgartirish",   'label_en': 'Change language','emoji': '', 'order': 12},
]
